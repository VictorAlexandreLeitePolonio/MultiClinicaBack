...
public class CategoriasProdutoController(ICategoriaProdutoService service) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> Create(CreateCategoriaProdutoDto dto)
    {
    ...
    public async Task<IActionResult> Update(int id, UpdateCategoriaProdutoDto dto)
    {
