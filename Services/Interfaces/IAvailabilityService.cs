...
public interface IAvailabilityService
{
    ...
    Task<Result<ClinicAvailabilityDto>> GetClinicAvailabilityAsync(int clinicId, DateOnly date, int patientAccountId);
    Task<Result<int>> ValidateRequestedSlotAsync(int clinicId, DateTimeOffset start, int patientAccountId);
